<script lang="ts">
	...
	// doesn't jump when the page replaces it. Shown by the page itself while its
	// notifications query has no data yet, and by the app shell during a navigation
	// that outlasts the delay gate. Pulse is CSS-only, so app.css's
