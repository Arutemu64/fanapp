...
const ERROR_MESSAGES = {
	...
	CURRENT_SCHEDULE_ITEM_NOT_ALLOWED: 'Это выступление нельзя отметить как текущее',
	...
	SAME_SCHEDULE_ITEMS_ARE_NOT_ALLOWED: 'Нельзя выбрать одно и то же выступление',
	SCHEDULE_ITEM_NOT_FOUND: 'Выступление не найдено',
	SKIPPED_SCHEDULE_ITEM_NOT_ALLOWED: 'Пропущенное выступление нельзя отметить как текущее',
