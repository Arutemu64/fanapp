...
* A version pinned in more than one place → bump every site together and keep `.github/renovate.json` covering them. See [docs/dependencies.md](docs/dependencies.md).
